...
public class EsgDetailModel {
	...
	private Long modelbankid;
	private Long modellastmodifiedby;
	private Long modeluserstatusid;

	public Long getModeluserstatusid() {
		return modeluserstatusid;
	}

	public void setModeluserstatusid(Long modeluserstatusid) {
		this.modeluserstatusid = modeluserstatusid;
	}
	...
	public Long getModelbankid() {
		return modelbankid;
	}

	public void setModelbankid(Long modelbankid) {
		this.modelbankid = modelbankid;
	}

	public Long getModellastmodifiedby() {
		return modellastmodifiedby;
	}

	public void setModellastmodifiedby(Long modellastmodifiedby) {
		this.modellastmodifiedby = modellastmodifiedby;
	}
